      ...
      <div className="About">
        <div className="data">
          ...
          <div className="grid-container">
            ...
            <p className="grid2">
              FC Lorient (on loan from <span className="eee">Hammarby IF</span>{" "}
              ){" "}
            </p>
        ...
        <div id="About2">
          ...
          <p className="etext">
            ...
            <p className="etext2">
              ...
              permanent transfer from Danbort by signing a four years contract.
              On 17 September the same year, Adjei made his{" "}
          ...
          <p className="etext">
            ...
            <p className="etext2">
              ...
              <span className="eee">at age 16.</span> <br />
              <p className="etext2">
